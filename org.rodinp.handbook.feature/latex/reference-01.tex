...
%\begin{center}
%	\includegraphics{img/reference/ref_02_symbol_table1.png}
%	\caption{Auto Prover Preferences}
%	\label{fig_ref_02_symbol_table1}
%\end{center}
%\end{figure}
...
%\begin{center}
%	\includegraphics{img/reference/ref_03_symbol_table1.png}
%	\caption{Auto Prover Preferences}
%	\label{fig_ref_03_symbol_table1}
%\end{center}
%\end{figure}
...
%\begin{figure}[!h]
%\begin{center}
%	\includegraphics{img/reference/ref_01_structurededitor1.png}
%	\caption{The Structured Editor}
%	\label{fig_ref_01_structurededitor1}
%\end{center}
%\end{figure}
