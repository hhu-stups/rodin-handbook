...
\begin{itemize}
    ...
    \item (p0) external provers can be invoked from the drop-down list to test sequents using different forces. \marginpar{need a p0 icon?}
...
\marginpar{need icons for p0,p1,pp,m0,m1,m2?}
\subparagraph{ML}
