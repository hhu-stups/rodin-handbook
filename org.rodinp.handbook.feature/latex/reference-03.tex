...
In many cases, this is just the conjunction of the well-definedness conditions for the different syntactical parts of a constrict.

See section~\ref{welldefinedness_of_assignments} for well-definedness of assignments.
