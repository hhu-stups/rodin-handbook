...
From the abstract: ``[\ldots] we present the Rodin modelling tool that seamlessly integrates modelling and proving. 
...
The authors J.-R.~Abrial, M.~Butler, S.~Hallerstede, T.~S.~Hoang, F.~Mehta and L.~Voisin
published the article in the journal Software Tools and Technology Transfer (STTT).
