...
The symbols view is intended to give users a convenient way to add mathematical symbols to the various model editors. If an editor is open and a text field is active (the cursor is blinking), then clicking a symbol inserts it at the current position as demonstrated in Figure \ref{fig_ref_01_symbol_table1}. 
...
\info{The editor described here was the default editor until Rodin 2.3.  It is still available, but has to be started explicitly through the context menu of the Component.}
