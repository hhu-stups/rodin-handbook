...
More formally, we define the set of free identifiers \freeids{E} of an expression or predicate $E$ recursively as follows:
...
\begin{rodinrefentry}
  \rrdesc
    ...
    If a relation $r$ relates an element $x$ to $y$ and $s$ relates $x$ to $z$,
...
\begin{rodinrefentry}
  \rrdesc
    ...
    $\mathsf{E}$ is restricted to expressions whose type does not depend on an argument of that expression.
