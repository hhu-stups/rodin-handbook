...
\begin{itemize}
	\item Windows 32bit (\texttt{rodin-*-win32.win32.x86.zip})
	\item Mac OS 64bit (\texttt{rodin-*-macosx.cocoa.x86\_64.zip})
	\item Linux 32bit (\texttt{rodin-*-linux.gtk.x86.zip})
\end{itemize}
