...
\info{It exist an easy way to generate the contants, the set and the axiom automatically. Therefore, click on the \textsf{New Enumarated Set Wizard} tool bar item and enter the set name and constant names in the corresponding wizard. The wizard will create the corresponding items (constants, set and axiom) automatically.}
