...
The editor is \textit{form-based}.  This means that in well-defined places an appropriate control (text field, dropdown, etc.) allows modifications. \marginpar{Must be adapted to Rodinv2.4}
...
\marginpar{This chapter needs to be adapted to Rodinv2.4}
