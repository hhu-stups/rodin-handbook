...
{
\vspace{1mm}
% TODO Daniel: Linie einfügen
%\hline
\vspace{1mm}
\noindent
{\scriptsize This contribution requires the \textbf{\tmpName} plugin.  The content is maintained by the plugin contributors and my be out of date.}
