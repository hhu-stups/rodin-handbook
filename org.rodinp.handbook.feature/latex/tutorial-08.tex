...
Import the archive file \file{Celebrity.zip}{Celebritiy Problem Download}. For this, choose \textsf{File $\rangle $ Import $\rangle $ General $\rangle $ Existing Project into workspace}. Then, select the according archive file and click on \textsf{Finish}.
