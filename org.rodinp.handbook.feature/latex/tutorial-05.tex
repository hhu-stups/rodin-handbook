...
We mark the axiom \texttt{solution} as a theorem (\ref{tut_concepts_contexts}) by clicking on the \textsf{not theorem} button as shown in figure \ref{fig_tut_05_mark_theorem}.
