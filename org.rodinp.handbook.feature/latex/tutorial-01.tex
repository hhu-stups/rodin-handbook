...
Comparing with the traditional development process, in a formal development we transfer some effort from the test phase (where we intend to verify the implementation), to the specification phase (where we intend to guarantee that the specification is correct in relation to the requirements).
