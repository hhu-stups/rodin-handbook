...
can be equivalently rewritten by $\exprb$ if $\expra$'s  well-definedness condition
is fulfilled.
...
\begin{rodinrefentry}
  \rrdesc
    ...
    can be used additionally to the constants, concrete variables and parameters in the predicate $Q$.
