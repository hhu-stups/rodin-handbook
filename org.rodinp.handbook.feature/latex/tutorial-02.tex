...
\warning{Rodin is easy to install on the platforms for which prebuild versions exist.  If no prebuild version exists for your platform, please check out Section~\ref{faq_os_not_supported} in the FAQ.}
