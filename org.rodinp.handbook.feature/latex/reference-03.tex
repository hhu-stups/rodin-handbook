...
%can be used additionally to the constants
    can also be used for the constants, concrete variables and parameters in the predicate $Q$. \marginpar{are the constants being used for or as the constants... in the predicate}
