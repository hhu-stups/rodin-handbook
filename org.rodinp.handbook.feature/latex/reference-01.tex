...
\begin{figure}[!ht]
\begin{center}
	\includegraphics{img/reference/ref_01_customizing2.png}
...
\begin{description}
	\item[A] from the \textsf{Window} $\rangle $ \textsf{Preferences} and then viewing the \textsf{Event-B} $\rangle $ \textsf{Sequent Prover} $\rangle $ \textsf{Auto/Post Tactic} page.
	\item[B] from the properties of a project to set project specific preferences for the \textsf{Auto/Post Tactic}.
	\item[C] from the drop-down menu in the \textsf{Proof Control} view.
\end{description}
The \textsf{Proof Control} view menu~\ref{fig_ref_01_proving_perspective13_14} shows whether there are sequent prover preferences set for the project containing the current proof obligation or not.
...
\begin{minipage}
\begin{tabular}{c}
\includegraphics{img/reference/ref_01_proving_perspective13.png} \\
(a)
\end{tabular}
\end{minipage}
%\hfill
\begin{minipage}
\begin{tabular}{c}
\includegraphics{img/reference/ref_01_proving_perspective14.png} \\
(b)
\end{tabular}
\end{minipage}
\caption{(a) direct access to the Celebrity project specific settings (b) no project settings exist for the current PO, direct access to workspace settings}
\label{fig_ref_01_proving_perspective13_14}
\end{figure}
