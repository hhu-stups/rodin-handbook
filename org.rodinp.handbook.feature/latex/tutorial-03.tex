...
You should see four proof obligations, two of which are discharged (marked with \inlineicon{rodin/discharged}) and two of which are not discharged (\inlineicon{rodin/pending}).

\info{\textbf{Proof obligations:} Have a look at the proof obligation labels.
