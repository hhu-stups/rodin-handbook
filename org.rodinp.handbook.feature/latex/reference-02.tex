...
If the event's guard is enabled, every action must be feasible.
  ...
  The feasibility operator $\actfis$ is defined in Section~\ref{assignments}. \marginpar{The feasibility operator is used in the referenced section, but it is never actually defined anywhere}
