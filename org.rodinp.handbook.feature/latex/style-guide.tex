...
\begin{itemize}
\item The most important thing about the index is the user perspective: 
  What is probably the word what a user could try to look up in the index?
...
\item Multiple index entries for the same text block are o.k.
