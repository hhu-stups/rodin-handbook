...
\pode{Guard strenghtening}%
  ...
  {$A(\allconstants) \land I(\allconstants,\allvariables)
    \land H(\allconstants,\concvariables,\concparameters)
    \land W(\allconstants,\allvariables,\absvariables',\concvariables',\allparameters)
    \land \concbeforeafter(\allparameters,\concvariables,\concparameters,\concvariables')
    \limp G(\allconstants,\absvariables,\absparameters)$}
